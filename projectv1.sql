...
INSERT INTO `user` (`user_id`, `user_name`, `user_pass`, `user_fname`, `user_lname`, `user_mname`, `user_address`, `user_email`, `user_role`, `user_created`, `user_updated`, `user_status`, `user_pos`, `user_yr`, `user_bod`, `user_img`, `user_gender`) VALUES
