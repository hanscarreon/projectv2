...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 13, 2020 at 11:05 AM
...
INSERT INTO `chat` (`chat_id`, `sender_id`, `reciever_id`, `chat_text`, `chat_status`, `chat_receiver_status`, `chat_created`, `chat_updated`, `message_status`) VALUES
(4, 3, 2, 'anak pota ka pahirap ka', 'published', 'inbox', '2020-08-25 15:12:38', '0000-00-00 00:00:00', 0),
(129, 3, 2, 'please', 'published', 'inbox', '2020-09-13 02:39:15', '0000-00-00 00:00:00', 0),
(134, 3, 14, 'example', 'published', 'inbox', '2020-09-13 03:18:20', '0000-00-00 00:00:00', 0),
(137, 3, 14, 'sample', 'published', 'inbox', '2020-09-13 03:18:56', '0000-00-00 00:00:00', 0),
(138, 3, 14, 'sample', 'published', 'inbox', '2020-09-13 03:19:18', '0000-00-00 00:00:00', 0),
(139, 3, 14, 'sdghsjd', 'published', 'inbox', '2020-09-13 06:51:49', '0000-00-00 00:00:00', 0);
...
(9, 3, 2, 3, '2020-08-29 13:51:00', '', '', 'waiting', 'published', '2020-08-25 13:51:23', '0000-00-00 00:00:00', 'none', 'adkjlasdnhba'),
(10, 4, 2, 3, '2020-09-05 04:17:00', '', '', 'waiting', 'published', '2020-08-26 13:14:57', '0000-00-00 00:00:00', 'none', 'sasas'),
(11, 47, 14, 13, '2020-09-18 07:29:00', '', '', 'waiting', 'published', '2020-09-07 07:29:53', '0000-00-00 00:00:00', 'none', 'carlo pepe'),
(12, 13, 4, 5, '2020-09-12 07:06:00', '', '', 'waiting', 'published', '2020-09-11 22:06:20', '0000-00-00 00:00:00', 'none', '');
...
INSERT INTO `sentiment_case` (`case_id`, `user_id`, `case_text`, `case_study`, `case_note`, `case_con`, `case_status`, `case_file`, `case_created`, `case_updated`, `case_neg_percent`, `case_neg`, `case_mid_percent`, `case_mid`, `case_pos_percent`, `case_pos`, `case_total_lines`) VALUES
...
(13, 4, 'what ever', 'neutral', '', 'meeting', 'published', '', '2020-09-11 07:06:20', '0000-00-00 00:00:00', '', 0, '', 0, '', 0, 0),
...
(49, 0, '{', 'positive', '', 'ongoing', 'deleted', '', '2020-09-07 14:51:06', '0000-00-00 00:00:00', '', 0, '', 0, '', 0, 0),
(50, 0, '{', 'positive', '', 'ongoing', 'deleted', '', '2020-09-07 14:51:03', '0000-00-00 00:00:00', '', 0, '', 0, '', 0, 0),
...
CREATE TABLE `user` (
  ...
  `user_messenger_link` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(2, 'colstud', 'E10ADC3949BA59ABBE56E057F20F883E', 'christian', 'carreon', 'aqunino', '', 'student1@gmail.com', 'student', '2020-08-14 12:49:30', '0000-00-00 00:00:00', 'published', 'col', '', '0000-00-00 00:00:00', '', 'none', '611863288873731'),
(3, 'coladv', 'E10ADC3949BA59ABBE56E057F20F883E', 'hentai', 'des', 'kamen', '', 'col123@gmail.com', 'admin', '2020-08-14 12:52:05', '0000-00-00 00:00:00', 'published', 'col', '', '0000-00-00 00:00:00', '', 'none', '611863288873731'),
...
(14, 'ben123', 'E10ADC3949BA59ABBE56E057F20F883E', 'Ben10', 'Manalotow', 'Tulfo', 'bukid', 'ben123@my.jru.edu', 'student', '2020-09-06 15:52:05', '0000-00-00 00:00:00', 'published', 'col', '3', '2000-06-12 16:00:00', '', 'male', '100013633363083');
...
--
ALTER TABLE `chat`
  MODIFY `chat_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=140;
--
-- AUTO_INCREMENT for table `sentimend_meeting`
--
ALTER TABLE `sentimend_meeting`
  MODIFY `meet_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
-- AUTO_INCREMENT for table `sentiment_case`
--
ALTER TABLE `sentiment_case`
  MODIFY `case_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;
--
