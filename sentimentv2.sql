...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 31, 2020 at 01:26 PM
...
INSERT INTO `admin` (`admin_id`, `admin_uname`, `admin_email`, `admin_pass`, `admin_fname`, `admin_gender`, `admin_expertise`, `admin_role`, `admin_status`, `admin_address`, `admin_contact`, `admin_pic`, `admin_created`, `admin_update`) VALUES
(1, 'guidance', '', '8724aa758c2f662d79952870ef486ea6', 'guidance v1', 'male', 'P.E', 'guidance', 'published', 'pasay city', '11111111', 'uploads/admin/5.png', '2020-10-27 10:27:07', '2020-10-27 11:01:39'),
(2, 'admin', '', '8724aa758c2f662d79952870ef486ea6', 'Ako si admin', 'male', 'mag salita', 'admin', 'published', 'wews', '', '', '2020-10-27 10:27:07', '2020-10-28 07:53:55'),
(3, 'admin2', 'admin@gmail.com', '8724aa758c2f662d79952870ef486ea6', 'guidance v2', 'male', 'wwla lang', 'admin', 'published', '', '2222222222', '', '2020-10-27 10:27:07', '2020-10-28 06:05:07'),
(4, 'admin3', 'adminv2@gmail.com', '8724aa758c2f662d79952870ef486ea6', 'guidance v3', 'male', 'admin', 'admin', 'published', '', '33333333', '', '2020-10-27 10:27:07', '2020-10-28 06:20:23'),
(5, 'colGTO123', 'colGTO123@jru.edu', '8724aa758c2f662d79952870ef486ea6', 'College GTO', 'male', 'Math', 'guidance', 'published', 'val city', '', 'uploads/admin/5.png', '2020-10-28 06:12:34', '2020-10-28 07:51:16');
...
CREATE TABLE `sentiment_case` (
  ...
  `case_updates` timestamp NULL DEFAULT NULL ON UPDATE current_timestamp(),
...
(1, 'fukcking egg go die', 3, 1, 2, '', 'closed', 'published', '', '2020-10-27 09:14:04', '2020-10-27 09:14:04', 'negative', 1, '100%', 1, '0%', 0, '0%', 0, 0, 'peers,emotion', '', 'zoom'),
(2, 'good to team, lets go we can do it', 3, 1, 3, '', 'closed', 'published', '', '2020-10-27 11:13:36', '2020-10-27 11:13:36', 'positive', 1, '0%', 0, '0%', 0, '100%', 1, 0, 'family,peers,relationship', '', 'email'),
...
CREATE TABLE `sentiment_meeting` (
  ...
  `meet_update` timestamp NULL DEFAULT NULL ON UPDATE current_timestamp(),
...
(2, '2020-10-25 12:19:58', '2020-10-25 07:14:13', '2020-10-28 02:22:35', 'tttt', 'uploads/plan/dddd10.pdf', 'published', 'done', 3, 1, 1, 'limksss'),
...
(4, '2020-11-07 11:03:00', '2020-10-27 11:04:01', NULL, '', '', 'published', 'pending', 3, 1, 7, ''),
...
CREATE TABLE `users` (
  ...
  `user_status` enum('active','pending','deleted') NOT NULL,
  ...
  `user_update` timestamp NULL DEFAULT NULL ON UPDATE current_timestamp(),
...
(1, '11-1', 'ben', '', '', '', 'junior highschool', 'admin', '', 'none', 'active', '', '', 0, '', '', 'male', '2020-10-28 01:37:01', NULL, '', NULL),
(2, '11-23123123', '', '', '123123@dggs.com', '8724aa758c2f662d79952870ef486ea6', 'none', 'admin', '', 'none', 'active', '', '', 0, '', '', 'male', '2020-10-28 01:37:14', NULL, '', NULL),
(3, '11-111111', 'Gio martinez', 'uploads/student/3.png', 'studentone@my.jru.edu', '8724aa758c2f662d79952870ef486ea6', 'graduate', 'student', 'b - 1s', 'higher education', 'active', '', 'b - 1', 0, 'karuhatan valenzuela', '', 'male', '2020-10-27 10:28:10', '2020-10-31 08:52:00', '09574737464', '1998-11-13'),
(4, '22-2222222', 'test name one', '', 'test2student@my.jru.edu', '8724aa758c2f662d79952870ef486ea6', 'junior highschool', 'student', '', 'none', 'active', '', '', 0, 'karuhatan valenzuela', '', 'male', NULL, NULL, '12312312312', '2020-10-27');
...
--
ALTER TABLE `sentiment_meeting`
  MODIFY `meet_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
