        	...
        	<div class="row">
	          ...
	          <div class="col-12 card shadow mb-4">
                ...
                <div class="text-center">
                  <img class="info-admin-img img-fluid img-circle" height="auto" width="30%" src="<?php echo !empty($info[0]['user_pic']) ? base_url().$info[0]['user_pic'] :  base_url('resources/img/stud.png') ?>" alt="no info picture available">
                </div>
	            ...
	            <form class="form-horizontal" id="case-form" method="post">
                      ...
                      <!-- /. user Name -->
                        ...
                        <div class="err col-sm-10">
                          <div class="input-group mb-3">
                              <input type="text" class="form-control" disabled="" id="user_fname" name="user_fname" value="<?php echo ucfirst($info[0]['user_fname']) ?>" name="">
                            <div class="input-group-append">
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="err col-sm-10">
                          <div class="input-group mb-3">
                              <input type="text" class="form-control" disabled="" id="user_address" name="user_address" value="<?php echo$info[0]['user_address'] ?>" >
                            <div class="input-group-append">
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="form-group row">
                            ...
                            <div class="err col-sm-10">
                                <div class="input-group mb-3">
                                <input type="text" disabled class="form-control" id="user_degree" name="user_degree" placeholder="For SHS and Higher Education"  value="<?php echo $info[0]['user_degree'] ?>" >
                                </div>
                            </div>
                       </div>
                        <!-- /. degree  -->
                        ...
                        <div class="form-group row">
                            ...
                            <div class="err col-sm-10">
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" id="user_section" name="user_section" placeholder="Year/Section" value="<?php echo $info[0]['user_section'] ?>" disabled>
                                <div class="input-group-append">
                                </div>
                            </div>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="err col-sm-10">
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" id="user_contact" name="user_contact" placeholder="Contact #:" value="<?php echo $info[0]['user_contact'] ?>" disabled>
                                <div class="input-group-append">
                                </div>
                            </div>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="err col-sm-10">
                                <div class="input-group mb-3">
                                    <select class="form-control select2 select2-hidden-accessible" id="user_status" name="user_status"  style="width: 100%;" disabled data-select2-id="1" tabindex="-1" aria-hidden="true">
                                    <option value="">select gender</option>
                      ...
                      <a class="btn btn-primary" href="<?php echo base_url('admin/account/edit-student/').$info[0]['user_id'] ?>">Edit</a>
