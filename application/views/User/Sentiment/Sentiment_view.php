                ...
                <?php  else: ?>
                  ...
                  <?php  foreach($guidances as $guidance): ?>
                    <div class="form-check form-check-inline mb-2 col-md-4 col-sm-6 col-12">
                        <input class="form-check-input" type="radio" <?php echo  $case[0]["admin_id"] == $guidance['admin_id'] ? 'checked': ''  ?> id="sir<?php echo $guidance['admin_id'] ?>" value="<?php echo $guidance['admin_id'] ?>" name="admin_id" disabled>
