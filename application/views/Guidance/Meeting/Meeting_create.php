<div class="container-fluid">
  <div class="col-12 p-0 m-0 mb-2">
    <div class="card col-lg-3 col-sm-12 p-0 mb-2">
      <div class="card-header bg-primary">
        <div class="title">
          <h4 class="text-white p-0 m-0 text-shadow-lg">Send Meeting Link here</h4>
        </div>
      </div>
      <div class="card-body">
    ...
    <div class="card col-lg-8 col-sm-12 p-0 m-0 mb-4">
      <div class="card-header bg-primary">
        <div class="title">
          <h4 class="text-white p-0 m-0 text-shadow-lg">Meeting Note</h4>
        </div>
      </div>
      <div class="card-body">
