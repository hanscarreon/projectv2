                    ...
                    <?php  if ( isset( $sentiments ) && count($sentiments) >= 1 ):?>
                      ...
                      <?php $x=1; foreach($sentiments as $sentiment): ?>
                        <tr>
                          ...
                          <td class="text-right"><a href="<?php echo base_url('guidance/sentiment/view/').$sentiment['case_id'] ?>"> <i class="fa fa-eye"></i> </a></td>
                          <td><a href="<?php echo base_url('guidance/archive/retrieve/').$sentiment['case_id'] ?>"> <i class="fa fa-recycle"></i> </a></td>
                        </tr>
                      <?php endforeach; ?>
